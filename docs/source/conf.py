...
myst_html_meta = {
    "description": "Use FraudLabs Pro Kotlin SDK to screen the order transaction for payment fraud.",
    "keywords": "FraudLabs Pro, Fraud Prevention, Fraud Detection, Kotlin",
...
html_title = "FraudLabs Pro Kotlin"

# html_baseurl = "https://fraudlabspro-kotlin.readthedocs.io/en/latest/"