...
Screens a order transaction for fraud.
...
:return: Returns the fraud checking results in array. Refer below table for the fields avaliable in the array
:rtype: array
