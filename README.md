...
========================
This Kotlin module enables user to easily implement fraud detection feature into their solution using the API from https://www.fraudlabspro.com.
...
To learn more about installation, usage, and code examples, please visit the developer documentation at [https://fraudlabspro-kotlin.readthedocs.io/en/latest/index.html.](https://fraudlabspro-kotlin.readthedocs.io/en/latest/index.html)
